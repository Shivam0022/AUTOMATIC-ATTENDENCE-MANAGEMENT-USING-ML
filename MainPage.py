...
def function8():
    os.system("FACE_DETECTION_AND_FACE_RECOGNITION.pdf")


def function9():
    os.system("python AAS_Show.py")
...
Button(root,text="Show Report",font=("times new roman",20),bg=color_Buttons,fg='white',command=function8).grid(row=10,column=2, columnspan=2,sticky=N+E+W+S,padx=5,pady=5)

Button(root,text="Flowchart & Working Steps",font=("times new roman",20),bg=color_Buttons,fg='white',command=function9).grid(row=12,column=0, columnspan=2,sticky=N+E+W+S,padx=5,pady=5)
Button(root,text="About Us",font=("times new roman",20),bg=color_Buttons,fg='white',command=function10).grid(row=12,column=2, columnspan=2,sticky=N+E+W+S,padx=5,pady=5)

Button(root,text="Exit",font=('times new roman',20),bg=color_Exit,fg="white",command=function11).grid(row=14,columnspan=4,sticky=N+E+W+S,padx=5,pady=5)
